export class AccountListController {
  ...
  onDeleteAccount(userAccount) {
    ...
    var confirm = this.$mdDialog.prompt()
          .title("Would you like to remove this Outlook Mail integration with Yellowant?")
          .textContent(`Please type in your OutlookMail handle to confirm: ${userAccount.user_invoke_name}`)
          .placeholder("Outlook Mail-handle")
          .ariaLabel("Outlook Mail Handle")
