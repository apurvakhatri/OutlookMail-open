...
class CommandCenter(object):
    ...
    def get_my_contacts(self, args):
        print("In get_my_contacts")
        ...
        r = make_api_call('GET', get_contacts_url, self.access_token, parameters=query_parameters)
    ...
    def get_my_events(self, args):
        print("In get_my_events")
        ...
        r = make_api_call('GET', get_events_url, self.access_token, parameters=query_parameters)
        print("dede")
        if (r.status_code == requests.codes.ok):
            print("in if")
            print(r.json())
